...
public class Calculator {
     ...
     *
     * @param x first number to be added (must be positive)
     * @param y second number to be added (must be positive)
     * @return sum of the arguments
     * @throws IllegalArgumentException when at least one of the arguments is less or equal 0
     */
